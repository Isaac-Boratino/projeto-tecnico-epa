...
### Objetivo geral
Desenvolver, com ESP32, um sistema de baixo custo que identifique automaticamente postes de iluminação pública com defeito (apagados, queimados ou acesos em horário errado) e notifique o responsável pela manutenção, sem depender de denúncia manual.
